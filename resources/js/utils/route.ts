...
'pagination.basic.table': never,
'pagination.basic.cards': never,
'pagination.table': never,
'pagination.cards': never,
settings: never,
'profile.edit': never,
...
const routes = {
    ...
    "pagination.basic.table": "pagination/basic/table",
    "pagination.basic.cards": "pagination/basic/cards",
